...
const accountRegistrationSchema = z
  .object({
    birthDate: z.string().refine((value) => value === "" || isValidBirthDate(value), "Podaj poprawną datę urodzenia."),
    ...
    phone: z.string().refine((value) => value === "" || /^\d{9}$/.test(value), "Podaj poprawny numer telefonu, 9 cyfr."),
  })
